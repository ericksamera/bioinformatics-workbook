...
As you start construct your search query, also notice how text in the the grey box changes. This displays the actual search query that is passed to the Nucleotide database (which we saw in [the previous section](2.1-retrieving-sequences-from-ncbi.md#c-search-details)).
